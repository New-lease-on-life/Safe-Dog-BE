...
/**
 * 인증 쿠키(access_token, refresh_token) 추가·삭제·읽기. HttpOnly, SameSite=Lax, path/secure는 설정에 따라 적용.
 * refresh_token은 /api/auth/refresh 경로로만 전송.
 */
@Component
public class CookieUtils {
  ...
  public void addRefreshTokenCookie(HttpServletResponse response, String token) {
    addCookie(response, REFRESH_TOKEN_COOKIE, token, REFRESH_TOKEN_MAX_AGE_SECONDS,
        REFRESH_TOKEN_PATH);
  }
